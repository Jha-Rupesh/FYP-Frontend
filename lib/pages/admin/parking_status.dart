...
class AdminParkingStatus extends StatefulWidget {
  ...
  @override
  _AdminParkingStatusState createState() => _AdminParkingStatusState();
}

class _AdminParkingStatusState extends State<AdminParkingStatus> {
  List data = [];
  List data1 = [];
  ...
  _bookingData() {
    AdminHomeService.bookDatas().then((response) async {
